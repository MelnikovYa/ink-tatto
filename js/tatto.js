...
let myArray = [image1,image2,image3,image4,image5,image6,image7,image8,image9,image10,image11,image12]
...
// MENU
// let popup = document.querySelector(".header__menu-ul");
// let closePopupButton = popup.querySelector(".fa-times");
// let openPopupButton = document.querySelector(".close__menu");
// let closeBars = document.querySelector(".fa-bars");
// let closeTextMenu = document.querySelector(".header__menu-text");

// openPopupButton.addEventListener("click", function() {
//   popup.classList.add("popup--open");
//   openPopupButton.classList.add("bars-close");
// });
// closePopupButton.addEventListener("click", function() {
//   popup.classList.remove("popup--open");
//   openPopupButton.classList.remove("bars-close");
// });
$(function(){
